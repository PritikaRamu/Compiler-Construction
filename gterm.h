...
typedef enum {
	...
	eps, definetypestmt, A, TK_ASSIGNOP, TK_COMMENT, TK_FIELDID, TK_ID, TK_NUM, TK_RNUM, TK_FUNID, TK_WITH, TK_PARAMETERS, TK_END, TK_WHILE, TK_TYPE, TK_MAIN,
...
// Delete allVar, allVarTemp, all, temp
// Add actualOrRedefined, fieldtype, option_single_constructed, oneExpansion, moreExpansions
// Change Numbers!!! (definetypestmt, A)
